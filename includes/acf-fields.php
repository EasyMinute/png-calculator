...
add_action( 'acf/include_fields', function() {
	...
	acf_add_local_field_group( array(
		...
		'fields' => array(
			...
			array(
				'key' => 'field_67646cc5c9ee9',
				'label' => 'Коефіцієнти прямого друку на білих тканинах',
				'name' => '',
				'aria-label' => '',
				'type' => 'accordion',
				'instructions' => '',
			...
			array(
				'key' => 'field_67646d0fc9eeb',
				'label' => 'Коефіцієнти прямого друку на білих тканинах',
				'name' => 'white_direct_koefs',
				'aria-label' => '',
				'type' => 'repeater',
				'instructions' => '',
				'required' => 0,
				...
				'sub_fields' => array(
					array(
						...
						'ajax' => 0,
						'placeholder' => '',
						'parent_repeater' => 'field_67646d0fc9eeb',
					),
					array(
						'key' => 'field_67646d0fc9eed',
						'label' => 'Тираж - ціна',
						'name' => 'products_price',
						'aria-label' => '',
						'type' => 'repeater',
						...
						'sub_fields' => array(
							array(
								...
								'prepend' => '',
								'append' => '',
								'parent_repeater' => 'field_67646d0fc9eed',
							),
							array(
								'key' => 'field_67646d0fc9eef',
								'label' => 'Тираж до',
								'name' => 'quantity_max',
								'aria-label' => '',
								'type' => 'number',
			...
			array(
				'key' => 'field_67646d9ec9ef1',
				'label' => 'Коефіцієнти прямого друку на кольорових тканинах',
				'name' => '',
				'aria-label' => '',
				'type' => 'accordion',
				'instructions' => '',
			...
			array(
				'key' => 'field_67646dc1c9ef2',
				'label' => 'Коефіцієнти прямого друку на кольорових тканинах',
				'name' => 'color_direct_koefs',
				'aria-label' => '',
				'type' => 'repeater',
				'instructions' => '',
				'required' => 0,
				...
				'sub_fields' => array(
					array(
						...
						'ajax' => 0,
						'placeholder' => '',
						'parent_repeater' => 'field_67646dc1c9ef2',
					),
					array(
						'key' => 'field_67646dc1c9ef4',
						'label' => 'Тираж - ціна',
						'name' => 'products_price',
						'aria-label' => '',
						'type' => 'repeater',
						...
						'sub_fields' => array(
							array(
								...
								'prepend' => '',
								'append' => '',
								'parent_repeater' => 'field_67646dc1c9ef4',
							),
							array(
								'key' => 'field_67646dc1c9ef6',
								'label' => 'Тираж до',
								'name' => 'quantity_max',
								'aria-label' => '',
								'type' => 'number',
