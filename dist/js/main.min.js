...
// PRINT CALCULATION
document.addEventListener('DOMContentLoaded', function () {
  var maxPrints = 5; // Maximum allowed print configurations
  var currentPrints = 0; // Current count of visible print groups
  ...
  var productQuantityInput = document.getElementById('product_quantity'); // Product quantity input
  var printFinalPriceInput = document.getElementById('print_final_price'); // Final price per print
  var printSumInput = document.getElementById('print_sum'); // Total print sum
  ...
  function createPrintGroup() {
    ...
    var newGroup = template.cloneNode(true); // Clone the hidden template
  ...
  function populatePrintFormats(printType, formatSelect) {
    var koefs = koefsMap[printType] || []; // Get the koefs array or an empty array
  ...
  function calculatePrintCosts() {
    ...
    var totalPrice = 0; // To calculate total cost across all groups

    printGroups.forEach(function (group) {
      var printTypeSelect = group.querySelector('.printType');
      var printFormatSelect = group.querySelector('.printFormat');
      var selectedPrintType = printTypeSelect.value;
      var selectedFormat = printFormatSelect.value;
      if (!selectedPrintType || !selectedFormat) return;
      var koefs = koefsMap[selectedPrintType] || [];
      var formatData = koefs.find(function (item) {
        return item.format.value === selectedFormat;
      });
      ...
      if (matchedKoef) {
        var unitPrice = parseFloat(matchedKoef.koef);
  ...
  function initializePrintGroups() {
    for (var i = 0; i < maxPrints; i++) {
      var printTypeSelect = document.getElementById("printType_".concat(i));
      var printFormatSelect = document.getElementById("printFormat_".concat(i));
