...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function populatePrintFormats(printType, formatSelect) {
    var koefs = koefsMap[printType] || [];
    var $formatSelect = jquery__WEBPACK_IMPORTED_MODULE_0___default()(formatSelect);
    console.log('koefs', koefs);
    $formatSelect.empty(); // Clear existing options

    koefs.forEach(function (_ref) {
      var format = _ref.format;
      var option = new Option(format.label, format.value, false, false);
  ...
  function calculatePrintCosts() {
    ...
    printGroups.forEach(function (group) {
      ...
      var koefs = koefsMap[printType] || [];
      var formatData = koefs.find(function (item) {
        return item.format.value === printFormat;
      });
      if (!formatData) return;
      var priceData = formatData.products_price;
      var matchedKoef = priceData.find(function (priceRange) {
        return productQuantity >= parseInt(priceRange.quantity_min) && productQuantity <= parseInt(priceRange.quantity_max);
      });
      if (matchedKoef) {
  ...
  function createPrintGroup() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(printFormatSelect).on('change', calculatePrintCosts);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (form) {
    var handleInputChange = function handleInputChange() {
      ...
      var printQuantity = parseInt(document.getElementById('print_quantity').value) || 1;
